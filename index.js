...
x = setInterval(function () {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['HAPPY', 'BIRTHDAY!', 'ZAKIYATUS', 'SANIA'],
      charSize: 30,
      charSpacing: 35,
      lineHeight: 40,
  ...
  function anim() {
    ...
    if (done && benerandone == 1) {
      ...
      function askQuestion() {
        ...
        Swal.fire({
          title: 'Menurut Kamu, Siapa Cowok yang Paling Ganteng, Lucu dan Menggemaskan?',
          input: 'text',
          ...
          if (result.isConfirmed) {
            ...
            if (answer.includes('abil') || answer.includes('kamu') || answer.includes('Abil')) {
              ...
              Swal.fire({
                icon: 'error',
                title: 'Salah!',
                text: 'Jawabannya bukan itu! Coba lagi!',
